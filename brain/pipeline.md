...
|---|---|---|---|---|
| **Alan Proudfoot** — `alan@lis.ac.th` (prof EPS, Lamai International School) — aussi joignable WhatsApp `+44 7867 501966` (nouveau numéro, pas encore dans les contacts) | Partenariat école | **2026-07-20 (a répondu, positif)** → **24/08 19h11 : a écrit sur WhatsApp** — de retour et installé sur l'île, propose de se rencontrer en face à face cette semaine (coaching + visite de l'école), dispo 9h-15h mardi à vendredi ou après 15h n'importe quel jour. Cyril a envoyé sa réponse (dispo **mercredi**) via WhatsApp → **Alan confirme mercredi 26/08, à partir de 15h.** RDV posé au calendrier. Cyril a envoyé sa proposition de **16h** via WhatsApp. En attente de la confirmation finale d'Alan. | ✅ RDV mer. 26/08 — proposition 16h envoyée |

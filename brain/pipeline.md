...
| **Alan Proudfoot** — `alan@lis.ac.th` (prof EPS, Lamai International School) — contact désormais par **WhatsApp** `+44 7867 501966` (nouveau numéro), plus par email (décision Cyril 26/08) | Partenariat école | **2026-07-20 (a répondu, positif)** → **24/08 19h11 : écrit sur WhatsApp**, de retour et installé sur l'île → RDV calé mercredi 26/08 16h → reporté par Cyril au vendredi 28/08 16h → **RDV eu lieu le jeudi 27/08 (confirmé par Cyril le 28/08)** — ⚠️ écart avec le calage vendredi 28/08 16h du calendrier/pipeline, non résolu : date/heure réelle et compte-rendu (coaching + visite école) `[À COMPLÉTER PAR CYRIL]`. Fiche de préparation utilisée : `brain/rdv-prep/2026-08-28-alan-proudfoot-lis.md`. | Prochaine action `[À COMPLÉTER PAR CYRIL]` selon l'issue du RDV | ✅ RDV eu lieu (27/08) |

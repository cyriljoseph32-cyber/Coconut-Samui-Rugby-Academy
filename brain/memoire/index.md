...
|---|---|---|---|---|---|
| [CSRA](projets/coconut-samui-rugby-academy.md) | Académie de rugby : site + brain agentique (QG des agents) | Astro + Tailwind | Vercel — coconutsamuirugby.com | 13/09 — post Instagram Touch Rugby publié (non vérifié, pas d'URL) ; PR #37 mergée : tarif Adults Touch 200 THB/séance en production ; 12/09 — flyers Kids/Teens + Touch Rugby (style Bloom validé), visuel d'annulation Kids Rugby (météo) ; 11/09 — post Instagram annonce training publié + Kids Rugby 4-12 ans, samedis 16h30-17h30 (PR #34 mergée) | 🟢 Actif |
...
| [jamin-depth](projets/jamin-depth.md) | **Jammin's Depths** — plongée & récupération sous-marine : site + système d'agents + moteur COCO COMMAND | Next.js 15 + Supabase + WhatsApp + Telegram | Vercel | 14/09 — reel Chumphon Pinnacle + White Rock publié (Instagram + Facebook, vérifié) ; 13/09 — 6 DSD réalisées (groupe Mario), revenu 35 100 THB total / 5 265 THB part Cyril (15 %) ; 02/09 — PR #16 `coco-contenu` + calendrier éditorial + adaptateur Instagram rouverte | 🟢 Actif |

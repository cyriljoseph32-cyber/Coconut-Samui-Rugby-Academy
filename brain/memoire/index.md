...
|---|---|---|---|---|---|
| [CSRA](projets/coconut-samui-rugby-academy.md) | Académie de rugby : site + brain agentique (QG des agents) | Astro + Tailwind | Vercel — coconutsamuirugby.com | 01/09 — tarifs & horaires confirmés, plafond 12/coach retiré (PR #28 mergée) ; 31/08 — kit textile en pause (PR #27), calendrier éditorial hebdo (PR #26) | 🟢 Actif |
...
| [coco2](projets/coco2.md) | **Coco Samui Concierge** — chatbot touristique + serveur MCP | Astro + serverless + Claude Haiku | Vercel — coco-samui-ai.com | 02/09 — script Postiz prêt à lancer par Cyril (PR #18 mergée) ; 31/08 — garde-fous chat.js/Bloom confirmés mergés | 🟢 Actif |
| [jamin-depth](projets/jamin-depth.md) | **Jammin's Depths** — plongée & récupération sous-marine : site + système d'agents + moteur COCO COMMAND | Next.js 15 + Supabase + WhatsApp + Telegram | Vercel | 02/09 — **PR #16 mergée** (calendrier éditorial + adaptateur Instagram + `coco-contenu`, réellement sur `main`) et **PR #17 mergée** (`/approve` fait avancer le contenu lié) ; 28/08 — 4 posts Instagram DIVING publiés (confirmé Cyril) | 🟢 Actif |

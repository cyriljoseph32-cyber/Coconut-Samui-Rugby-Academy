...
|---|---|---|---|---|---|
| [CSRA](projets/coconut-samui-rugby-academy.md) | Académie de rugby : site + brain agentique (QG des agents) | Astro + Tailwind | Vercel — coconutsamuirugby.com | 12/09 — flyers Kids/Teens + Touch Rugby (style Bloom validé) ; tarif Adults Touch changé à 200 THB/séance sans mensuel, PR #37 en attente de review ; 11/09 — post Instagram annonce training publié + Kids Rugby passe à 4-12 ans, samedis 16h30-17h30, fusion de créneau avec Teens (PR #34 mergée) ; 10/09 — RDV Greenacre très positif, intérêt fort pour le tournoi/rencontre | 🟢 Actif |
...
| [coco2](projets/coco2.md) | **Coco Samui Concierge** — chatbot touristique + serveur MCP | Astro + serverless + Claude Haiku | Vercel — coco-samui-ai.com | 11/09 — post Instagram scooter/road trip publié ; 09/09 — post Instagram "Hidden gems" (cascade) publié ; 06/09 — resynchro posts Instagram : seul le post « Ask Coco » (31/08) réellement publié, 3 brouillons semaine 31/08 + 4 brouillons semaine 07/09 encore en attente | 🟢 Actif |
| [jamin-depth](projets/jamin-depth.md) | **Jammin's Depths** — plongée & récupération sous-marine : site + système d'agents + moteur COCO COMMAND | Next.js 15 + Supabase + WhatsApp + Telegram | Vercel | 02/09 — **PR #16 `coco-contenu` + calendrier éditorial + adaptateur Instagram rouverte** (l'ancienne PR #8 était fermée sans merge depuis le 23/08, écart non détecté) ; 28/08 — 4 posts Instagram DIVING publiés (confirmé Cyril) | 🟢 Actif |
